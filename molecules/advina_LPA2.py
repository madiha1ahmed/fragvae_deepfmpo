...
def adock(receptor_input,
 ...
 #      vina = 'autodockvina',
        ...
        seed=None,
        cpu=33,
        lig_dir = './lpa2_docking_score/ligand_files/',
        out_dir = './lpa2_docking_score/output/',
        log_dir = './lpa2_docking_score/log/',
        conf_dir = './lpa2_docking_score/config/'):
...
def calculateDockingScore(mol):
    ...
    protein_surface = '/home/student5/Downloads/Thesis_Madiha/old_fragmentation/fragvae-LPA1-LPA2-LPA3/DATA/protein_files/LPA2.pdbqt'
...
#import pandas as pd
#molecules = pd.read_csv('/home/student5/Downloads/drug_design_summer_project/DATA/train.smi')
#molecules = pd.read_csv('/home/student5/Downloads/Thesis_Madiha/new_fragmentation/fragvae_LPA1_LPA2_LPA3/DATA/ZINC/PROCESSED/train_wo_invalid.smi')
#molecules = molecules.iloc[:,2]

#docking_scores_LPA2 = []
#for smile in molecules:
 #   score = calculateDockingScore(smile)
 #   docking_scores_LPA2.append(score)
    
#pd.DataFrame(docking_scores_LPA2).to_csv('/home/student5/Downloads/drug_design_summer_project/protein_files/LPA2/LPA2-train-scores.csv')
#
