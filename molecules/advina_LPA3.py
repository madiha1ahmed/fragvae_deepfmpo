...
def adock(receptor_input,
 ...
 #      vina = 'autodockvina',
        ...
        seed=None,
        cpu=33,
        lig_dir = './lpa3_docking_score/ligand_files/',
        out_dir = './lpa3_docking_score/output/',
        log_dir = './lpa3_docking_score/log/',
        conf_dir = './lpa3_docking_score/config/'):
...
def calculateDockingScore(mol):
    ...
    protein_surface = '/home/student5/Downloads/drug_design_summer_project/protein_files/LPA3/LPA3.pdbqt'
...
#pd.DataFrame(docking_scores_LPA2).to_csv('/home/student5/Downloads/drug_design_summer_project/protein_files/LPA3/LPA3-train-scores.csv')
#
